          ...
          <Card.Text>
            ...
            {courseDetails.details.length > 250 ? (
              <p>
                ...
                <Link to={`/coursedetails/${courseDetails._id}`}>Read More</Link>
              </p>
            ) : (
              <p>{courseDetails.details}</p>
            )}
          </Card.Text>
          <Link to={`/coursedetails/${courseDetails._id}`}  style={{ marginTop: "auto" }}>
            <Button variant="outline-primary">Go Premium</Button>
          </Link>
        </Card.Body>
      </Card>
    </div>
